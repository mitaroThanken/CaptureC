...
using CaptureC.Contracts.Services;
using CaptureC.Contracts.ViewModels;
using CaptureC.Helpers;
using CaptureC.Models;

using Microsoft.Extensions.Options;

namespace CaptureC.ViewModels
{
    ...
    public class SettingsViewModel : Observable, INavigationAware
    {
        ...
        {
            VersionDescription = $"CaptureC - {_applicationInfoService.GetVersion()}";
